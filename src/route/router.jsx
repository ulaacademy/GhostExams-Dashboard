...
import StudentPlansList from "../pages/student-plans-list";
import SubscriptionsList from "../pages/subscriptions-list";
import StudentSubscriptionsList from "../pages/student-subscriptions-list";
import TeacherView from "../pages/teacher-view";
import StudentView from "../pages/student-view";
import GhostExaminationsList from "../pages/ghost-examinations-list";
...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            {
  path: "/student-plans/list",
  element: <StudentPlansList />
},
            ...
            {
  path: "/student-subscriptions/list",
  element: <StudentSubscriptionsList />
},

            {
                path: "/ghost-examinations/list",
                element: <GhostExaminationsList />
            },
