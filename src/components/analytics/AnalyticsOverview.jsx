...
import { FiUsers, FiFileText, FiDollarSign, FiTrendingUp, FiBook, FiUserCheck } from 'react-icons/fi'
import { fetchDashboardOverview, selectOverview, selectAnalyticsLoading } from '@/store/analyticsSlice'
...
const AnalyticsOverview = () => {
    ...
    const stats = [
        ...
        },
        {
            ...
            subtitle: `$${(overview?.overview?.monthlyRevenue || 0).toLocaleString()} this month`,
            icon: FiDollarSign,
            color: 'success',
            bgColor: 'bg-soft-success'
        }
                                ...
                                <div className="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div className="fs-4 fw-bold text-dark mb-1">
                                            {stat.value}
                                            {stat.total && (
                                                <span className="fs-13 text-muted fw-normal"> / {stat.total}</span>
                                            )}
                                        </div>
                                        <h3 className="fs-13 fw-semibold text-muted mb-0">{stat.title}</h3>
                                        {stat.subtitle && (
